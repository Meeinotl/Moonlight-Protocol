...
function Update () 
{
	if (Input.GetButtonDown("Sprint"))
	{
		if (!sprinting)
		{
			chMotor.movement.maxForwardSpeed += sprintAmount;
			chMotor.movement.maxSidewaysSpeed += sprintAmount;
			chMotor.movement.maxBackwardsSpeed += sprintAmount;
			sprinting = true;
			Debug.Log("Run!");
		}
		else
    ...
    function Update()
    {
    	...
    	if (chMotor.grounded && Input.GetKey("Sprint"))
    	{
    		speed = runSpeed;
    	}
    	if (Input.GetKey("c"))
