	...
	if (tutorial)
	{
		switch (step)
		{
			case 0: //Look
				...
				p0.guiTexture.pixelInset = Rect(0, 0, cam.pixelWidth / 3, cam.pixelHeight / 3);
			...
			case 1: //Move
				...
				p1.guiTexture.pixelInset = Rect(0, 0, cam.pixelWidth / 3, cam.pixelHeight / 3);
			...
			case 2: //Jump
				...
				p2.guiTexture.pixelInset = Rect(0, 0, cam.pixelWidth / 3, cam.pixelHeight / 3);
			...
			case 3: //Crouch
				...
				p3.guiTexture.pixelInset = Rect(0, 0, cam.pixelWidth / 3, cam.pixelHeight / 3);
			...
			case 4: //Uncrouch
				...
				p4.guiTexture.pixelInset = Rect(0, 0, cam.pixelWidth / 3, cam.pixelHeight / 3);
				if (Input.GetButtonDown("Crouch"))
				{
					step = 7;
				}
			...
			case 5: //Sprint
				...
				p5.guiTexture.pixelInset = Rect(0, 0, cam.pixelWidth / 3, cam.pixelHeight / 3);
			...
			case 6: //Unsprint
				...
				p6.guiTexture.pixelInset = Rect(0, 0, cam.pixelWidth / 3, cam.pixelHeight / 3);
				if (Input.GetButtonDown("Sprint"))
				{
					step++;
				}
			...
			case 7: //Interact
				...
				p7.guiTexture.pixelInset = Rect(0, 0, cam.pixelWidth / 3, cam.pixelHeight / 3);
			...
			case 8: //Shoot
				...
				p8.guiTexture.pixelInset = Rect(0, 0, cam.pixelWidth / 3, cam.pixelHeight / 3);
			...
			case 9: //safe
				...
				p9.guiTexture.pixelInset = Rect(0, 0, cam.pixelWidth / 3, cam.pixelHeight / 3);
				safeCount--;
				if (safeCount == 0)
				{
					step++;
